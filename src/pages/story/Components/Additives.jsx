  ...
  return (
    <>
      <div className="Story__grid grid grid-col-2">
        ...
        <div className="Story__item Story__text" data-aos="fade-left">
          ...
          <p>
            ...
            authentic tequila and the Canadian Sphynx. This has led us to
            creating SPHYNX Tequila®, the first female-led British tequila
            brand, with the rich history of Mexico at the heart of it.
          </p>
        </div>
      </div>
      <p data-aos="zoom-in">
        ...
        smooth that you wouldn't want to mix it with anything but exquisite
        company. As you raise your glass with SPHYNX Tequila® you will naturally
        be raising the bar.
      </p>
      ...
      <p className="text-center" data-aos="zoom-in">
        ...
        tailed, that was the moment we knew we’d not only found our distillery
      ...
      <p data-aos="zoom-in">
        ...
        we are creating a renaissance for the way we drink tequila and we assure
      ...
      <p data-aos="zoom-in">
        ...
        just for SPHYNX Tequila® giving you a unique smooth flavour that allows
      ...
      <p data-aos="zoom-in">
        ...
        in Mexico to perfect the design. Handcrafted from 100% recycled glass,
        we have created a timeless piece of art, as well as a conscious one. Our
        decanter represents good fortune and abundance like the Sphynx itself -
